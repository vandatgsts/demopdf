 ...
 */
package com.vandatgsts.mylibrary.pdfbox.pdmodel.common.filespecification;
...
public class PDComplexFileSpecification extends PDFileSpecification
{
     ...
     * {@link #setFile(String) setFile(String)} or the attachment will not be visible on
     * some viewers.
     *
     ...
     * {@link #setFileUnicode(String) setFileUnicode(String)} for cross-platform and
     ...
     * {@link #setEmbeddedFileUnicode(com.vandatgsts.mylibrary.pdfbox.pdmodel.common.filespecification.PDEmbeddedFile) setEmbeddedFileUnicode(PDEmbeddedFile)}
     ...
     * call
     * {@link #setEmbeddedFile(com.vandatgsts.mylibrary.pdfbox.pdmodel.common.filespecification.PDEmbeddedFile) setEmbeddedFile(PDEmbeddedFile)}
