...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.fdf.FDFIconFit;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.fdf.FDFNamedPageReference;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.fdf.FDFOptionElement;
...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.interactive.action.PDAdditionalActions;
    ...
    public FDFField(Element fieldXML) throws IOException
    {
        ...
        for (int i = 0; i < nodeList.getLength(); i++)
        {
            ...
            if (node instanceof Element)
            {
                ...
                {
                    setValue(com.vandatgsts.mylibrary.pdfbox.util.XMLUtil.getNodeValue(child));
                }
                else if (child.getTagName().equals("value-richtext"))
                {
                    setRichText(new COSString(com.vandatgsts.mylibrary.pdfbox.util.XMLUtil.getNodeValue(child)));
                }
