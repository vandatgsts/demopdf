...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.common.PDPageLabelRange;
...
public class PDPageLabels implements COSObjectable
{
     ...
     * {@link com.vandatgsts.mylibrary.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)}.
     * </p>
     *
     * @param document
     *            The document the page label dictionary is created for.
     * @see com.vandatgsts.mylibrary.pdfbox.pdmodel.PDDocumentCatalog#setPageLabels(PDPageLabels)
     */
