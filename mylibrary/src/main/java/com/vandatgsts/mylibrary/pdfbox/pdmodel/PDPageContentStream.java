...
import com.vandatgsts.mylibrary.harmony.awt.AWTColor;
import com.vandatgsts.mylibrary.harmony.awt.geom.AffineTransform;
import com.vandatgsts.mylibrary.pdfbox.contentstream.operator.OperatorName;
...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.graphics.image.PDInlineImage;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.graphics.pattern.PDTilingPattern;
...
import com.vandatgsts.mylibrary.pdfbox.util.Charsets;
import com.vandatgsts.mylibrary.pdfbox.util.Matrix;
import com.vandatgsts.mylibrary.pdfbox.util.NumberFormatUtil;
...
public final class PDPageContentStream implements Closeable
{
     ...
     * @throws IOException If there is an error writing to the page contents.
     * @deprecated use {@link #PDPageContentStream(PDDocument, PDPage, AppendMode, boolean)}
     */
    @Deprecated
     ...
     * {@link #PDPageContentStream(PDDocument, PDPage, AppendMode, boolean, boolean)}
     ...
     * @throws IOException If there is an error writing to the page contents.
     * @deprecated use {@link #PDPageContentStream(PDDocument, PDPage, AppendMode, boolean, boolean) }
     */
    @Deprecated
    public PDPageContentStream(PDDocument document, PDPage sourcePage, boolean appendContent,
