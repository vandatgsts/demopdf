 ...
 */
package com.vandatgsts.mylibrary.pdfbox.pdfparser;
...
import com.vandatgsts.mylibrary.pdfbox.cos.COSNull;
import com.vandatgsts.mylibrary.pdfbox.cos.COSNumber;
import com.vandatgsts.mylibrary.pdfbox.cos.COSObject;
import com.vandatgsts.mylibrary.pdfbox.cos.COSObjectKey;
...
import com.vandatgsts.mylibrary.pdfbox.pdfparser.BaseParser;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.EndstreamOutputStream;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.FDFParser;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.PDFObjectStreamParser;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.PDFParser;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.PDFXrefStreamParser;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.RandomAccessSource;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.XrefTrailerResolver;
import com.vandatgsts.mylibrary.pdfbox.pdfparser.XrefTrailerResolver.XRefType;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.encryption.AccessPermission;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.encryption.DecryptionMaterial;
...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.encryption.PublicKeyDecryptionMaterial;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.encryption.SecurityHandler;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.encryption.StandardDecryptionMaterial;

import static com.vandatgsts.mylibrary.pdfbox.util.Charsets.ISO_8859_1;
...
public class COSParser extends BaseParser
{
    ...
    public static final String SYSPROP_PARSEMINIMAL =
        "com.vandatgsts.mylibrary.pdfbox.pdfparser.nonSequentialPDFParser.parseMinimal";
    ...
    public static final String SYSPROP_EOFLOOKUPRANGE =
        "com.vandatgsts.mylibrary.pdfbox.pdfparser.nonSequentialPDFParser.eofLookupRange";
        ...
        if (pdfObject.getObject() == null)
        {
            ...
            if (offsetOrObjstmObNr == null && isLenient && bfSearchCOSObjectKeyOffsets == null)
            {
                ...
                if (!bfSearchCOSObjectKeyOffsets.isEmpty())
                {
                    ...
                    final Set<Entry<COSObjectKey, Long>> entries = bfSearchCOSObjectKeyOffsets.entrySet();
