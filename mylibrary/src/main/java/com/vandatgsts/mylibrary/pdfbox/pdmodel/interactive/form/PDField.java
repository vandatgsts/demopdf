...
import com.vandatgsts.mylibrary.pdfbox.pdmodel.interactive.form.PDChoice;
import com.vandatgsts.mylibrary.pdfbox.pdmodel.interactive.form.PDFieldFactory;
...
public abstract class PDField implements COSObjectable
{
     ...
     * {@link PDTerminalField#setWidgets(List) setWidgets()} with the modified list.
     */
